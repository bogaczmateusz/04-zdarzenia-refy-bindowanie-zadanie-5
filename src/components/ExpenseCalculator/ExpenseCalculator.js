...
function ExpenseCalculator() {
    ...
    // comment function below to init empty lists
    useEffect(() => {
        const expensesList = localStorage.getItem('expenses') ? JSON.parse(localStorage.getItem('expenses')) : [];
        const incomesList = localStorage.getItem('incomes') ? JSON.parse(localStorage.getItem('incomes')) : [];
